...
def model_eval(model,X_test,Y_test,exp_name,model_name,run_name):
...
def evaluate(config):
    ...
    model_name = 'FinalRandomForestClassifier'
    run_name = 'FinalRandomForestClassifier'

    model_eval(model,X_test,Y_test,exp_name,model_name,run_name)
